...
export function TemplateSettingsPage({ path, disabled = false, onChange, onChoose }: {
  ...
  return <section className="settings-group template-settings" id="settings-group-templates">
    <SettingsGroupHeader title="新建项目" />
    <SettingsRow title="模板文件夹" wide description="将常用文件和文件夹放在此目录中，即可通过右键菜单的“新建项目”创建副本。子文件夹会显示为子菜单。支持一次勾选多个模板。创建完成后可重命名，取消重命名会保留副本。">
